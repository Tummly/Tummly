 ...
 * optional offer, legal footer, powered-by.
 */
export function BaseNonTransactionalEmail({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto w-full overflow-hidden rounded-[4px] bg-[var(--op-color-black)]",
        maxWidthClass,
        className
      )}
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute right-0 top-0 z-0 h-[330px] w-[560px] overflow-hidden"
      >
        <div
      ...
      <div className="relative z-10 flex flex-col items-start px-8 py-10">
      ...
      <div
        ...
        className="relative z-10 flex flex-col items-center overflow-clip px-8 pb-[60px] pt-8"
      >
