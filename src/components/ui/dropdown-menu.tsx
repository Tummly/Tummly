    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          // Instant open/close — fade+zoom+slide Presence felt laggy on navbar menus.
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[variant=success]:text-primary data-[variant=success]:focus:bg-primary/10 data-[variant=success]:focus:text-primary data-[variant=success]:*:[svg]:text-primary",
        "data-[variant=warning]:text-amber-600 data-[variant=warning]:focus:bg-amber-500/10 data-[variant=warning]:focus:text-amber-700 data-[variant=warning]:*:[svg]:text-amber-600",
        className
      )}
      {...props}
    />
