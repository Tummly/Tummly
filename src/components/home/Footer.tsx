    ...
    <footer className="tummly-footer-section">
      <div className="footer-container">
        ...
        <div className="footer-bottom-row">
          <p>
            Tummly is operated by <a href="#">TUMMLY.COM LIMITED</a>, company
            number 16236040. Registered office: 71–75 Shelton Street, Covent
            Garden, London, WC2H 9JQ. Registered in England and Wales.
          </p>
        </div>
      </div>
    </footer>
