      ...
      <div className="container">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <h3>Capture guests from everyday touchpoints</h3>
          ...
          <div className="feature-card">
            <div className="image-wrapper">
              <img src={card2} alt="Hear what guests really think" />
            </div>

            <h3>Hear what guests really think</h3>
          ...
          <div className="feature-card">
            ...
            <h3>Bring guests back with simple offers</h3>
