...
type OperatorHomePerformanceDateRangeControlProps = {
...
export function OperatorHomePerformanceDateRangeControl({
  dateRangeLabel,
  selectedRange,
  onCommitRange,
}: OperatorHomePerformanceDateRangeControlProps) {
            ...
            <div className={PERFORMANCE_DATE_CUSTOM_ACTIONS_CLASS}>
              ...
              <div className="flex items-center gap-1">
                ...
                <Button
                  ...
                  disabled={!canApply}
                  onClick={() => {
                    if (!canApply || draftStartKey == null || draftEndKey == null) {
                      return
                    }
                    onCommitRange({
                      kind: "custom",
