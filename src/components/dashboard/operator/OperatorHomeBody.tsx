...
import { OperatorHomePerformanceDateRangeControl } from "@/components/dashboard/operator/OperatorHomePerformanceDateRangeControl"
    ...
    <div className="flex flex-col gap-5">
      ...
      <section className={PERFORMANCE_SECTION_CLASS}>
        <div className={PERFORMANCE_HEADER_ROW_CLASS}>
          ...
          <OperatorHomePerformanceDateRangeControl
