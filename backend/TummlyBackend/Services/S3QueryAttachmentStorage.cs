...
namespace TummlyBackend.Services
{
    public class S3QueryAttachmentStorage : IQueryAttachmentStorage
    {
        ...
        )
        {
            ...
            // Buffer so Content-Length is known; DO Spaces rejects unsigned chunked payloads.
        ...
        {
            // DO Spaces: endpoint carries the datacenter (e.g. lon1); SigV4 region must be us-east-1.
