...
{
    [ApiController]
    [Route("api/capture/performance")]
    [Authorize]
    public class CapturePerformanceController : ControllerBase
    {
        ...
        public CapturePerformanceController(
        ...
        )
        {
            ...
            // Location KPI primaries must stay aligned with the Active/Paused
            // placement rows shown alongside them (CapturePlacementsController
            // scopes the same way), so Archived QR activity is excluded here.
