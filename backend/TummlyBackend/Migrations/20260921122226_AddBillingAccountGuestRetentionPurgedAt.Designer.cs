...
namespace TummlyBackend.Migrations
{
    ...
    [Migration("20260921122226_AddBillingAccountGuestRetentionPurgedAt")]
    partial class AddBillingAccountGuestRetentionPurgedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TummlyBackend.Models.AdminPaymentRefundIntent", b =>
                {
                    ...
                    b.Property<string>("SourcePaymentOrderId")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.ToTable("AdminPaymentRefundIntents");
                });
            ...
            modelBuilder.Entity("TummlyBackend.Models.PrintReadyQrAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OfferCopyVersion")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("QrTokenFingerprint")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<string>("TemplatePackVersion")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasIndex("ShopOrderId", "QrType")
                        .IsUnique()
                        .HasFilter("[ShopOrderId] IS NOT NULL");

                    b.ToTable("PrintReadyQrAssets");
                });
            ...
            modelBuilder.Entity("TummlyBackend.Models.RevolutOrderIntent", b =>
                {
                    ...
                    b.Property<string>("PackLookupKey")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("TummlyBackend.Models.RevolutWebhookInboxItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Status", "RetryAfterUtc", "ClaimedAtUtc", "CreatedAtUtc");

                    b.ToTable("RevolutWebhookInboxItems");
                });
            ...
            modelBuilder.Entity("TummlyBackend.Models.TummlyVatInvoice", b =>
                {
                    ...
                    b.Property<string>("RelatedRevolutOrderId")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
